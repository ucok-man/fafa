export const INSTRUCTIONS = `You are a highly specialized AI assistant with an exceptional ability to parse and convert unstructured text into a structured JSON object.
